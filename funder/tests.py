...
class FunderSerializerTest(TestCase):
    ...
    def setUpTestData(cls):
        Funder.objects.create_user(
            username='Test_funder', 
            name_of_contact_person='Test_funder_contact', 
            name_of_business='Test_funder_business', 
            phone=+25612345667, 
            email='testfunderemail@test.com', 
